/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-fuerte-cob-common-0.4.5/debian/ros-fuerte-cob-common/opt/ros/fuerte/stacks/cob_common/brics_actuator/msg/CartesianPose.msg */
...
struct CartesianPose_ {
  ...
  typedef  ::brics_actuator::CartesianVector_<ContainerAllocator>  _position_type;
   ::brics_actuator::CartesianVector_<ContainerAllocator>  position;
...
{
template<class ContainerAllocator> struct IsMessage< ::brics_actuator::CartesianPose_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::brics_actuator::CartesianPose_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
